...
func TestSortByStartTime(t *testing.T) {
	...
	class1.StartTime = scheduling.MustParseTime("07:00:00")

	var class2 scheduling.Class
	class2.StartTime = scheduling.MustParseTime("08:00:00")

	var class3 scheduling.Class
	class3.StartTime = scheduling.MustParseTime("09:00:00")

	arr := []scheduling.Class{class3, class1, class2}
	result := arr

	sort.Sort(scheduling.ByStartTime(result))
